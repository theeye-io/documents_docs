...
Usando la pestaña con el icono de flecha (<):
...
![](./files/tags_edicion_2020.gif)# Que es Tagger de TheEye?
...
![](./files/valid_o_invalid_2020.png)
...
![](./files/bloques_on_off_2020.png)

![](./files/etiquetas_on_off_2020.gif)

Ocasionalmente aparecen bloques superpuestos. Cuando estos casos dificultan la selección del dato se puede remover bloques utilizando el botón para tal fin.

![](./files/remover_bloque_2020.png)

A continuación se muestra cómo remover bloques de texto

![](./files/REMOVER_BLOQUES_2020.gif)
